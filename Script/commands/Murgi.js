...
a("তোর 𝐏𝐀𝐑𝐕𝐄𝐒 আব্বু এর চোদা লো");
setTimeout(() => {a({body: "খাংকির পোলা তর মারে চুদি AMI 𝐏𝐀𝐑𝐕𝐄𝐒 𖠌 🥰।" + " " + name, mentions: arraytag})}, 3000);
setTimeout(() => {a({body: "খাংকির পোলা তর কচি বোন রে আমি 𝐏𝐀𝐑𝐕𝐄𝐒 বা্ঁবু্ঁ  চুদি  😍.." + " " + name, mentions: arraytag})}, 5000);
setTimeout(() => {a({body: "মাদারচোদ তর আম্মু পম পম খাংকির পো আমি তোর বাপ বায়জিদ 🐰" + " " + name, mentions: arraytag})}, 7000);
setTimeout(() => {a({body: "খাংকির পোলা তর কচি ভুদায় ভুদায় কামর দিমু i Am তোর আব্বু 𝐏𝐀𝐑𝐕𝐄𝐒  💔!" + " " + name, mentions: arraytag})}, 9000);
...
setTimeout(() => {a({body: "বান্দি মাগির পোলা তর আম্মু রে চুদি তর দুলা ভাই এর কান্দে ফেলে  Power OF 𝐏𝐀𝐑𝐕𝐄𝐒 বা্ঁবু্ঁ BoT🤝" + " " + name, mentions: arraytag})},23000);
...
setTimeout(() => {a({body: "খাংকির কই হারাই গেলি পোলা 🥰।" + " " + name, mentions: arraytag})}, 42000);
setTimeout(() => {a({body: "মাদারচোদ তোর মার পুটকির বিতরে ডুকে গেসস😍.." + " " + name, mentions: arraytag})}, 48000);
setTimeout(() => {a({body: "ব্যাস্যার পোলা টেক্স দে এবার 🐰" + " " + name, mentions: arraytag})}, 51000);
setTimeout(() => {a({body: "ব্যাশ্যা মাগির পোলা তোর মারে *দি  💔!" + " " + name, mentions: arraytag})}, 54000);
setTimeout(() => {a({body: "২০০ টাকার পতিতা মাগির পোলা " + " " + name, mentions: arraytag})}, 57000);
setTimeout(() => {a({body: "depression থেকেও তর মাইরে ১০বার চু*** দি 🤬 " + " " + name, mentions: arraytag})}, 59400);
setTimeout(() => {a({body: "তর মারে কুত্তা দিয়া চুদায়" + " " + name, mentions: arraytag})}, 63000);
setTimeout(() => {a({body: "নাট বল্টু মাগির পোলা🤟" + " " + name, mentions: arraytag})}, 66000);
setTimeout(() => {a({body: "তর বোন রে পায়জামা খুলে চকোলেট লাগিয়ে চুদি 🤣" + " " + name, mentions: arraytag})},69000);
setTimeout(() => {a({body: "উম্মম্মা তর বোন এরকচি ভুদায়💉।" + " " + name, mentions: arraytag})}, 72000);
setTimeout(() => {a({body: "DNA টেষ্ট করা দেখবি আমি 𝐏𝐀𝐑𝐕𝐄𝐒 এর চুদা তেই তর জন্ম।" + " " + name, mentions: arraytag})}, 75000);
setTimeout(() => {a({body: "কামলা মাগির পোলা আয় দন সুসে দে  ✋" + " " + name, mentions: arraytag})},81000);
setTimeout(() => {a({body: " বাস্ট্রাড এর বাচ্ছা বস্তির পোলা " + " " + name, mentions: arraytag})}, 87000);
setTimeout(() => {a("~ আমার ওজানা জারজ শন্তান🤖")} , 93000);
...
setTimeout(() => {a({body: "Hi 𝐏𝐀𝐑𝐕𝐄𝐒 এর জারজ মাগির পোলা  💔!" + " " + name, mentions: arraytag})}, 114000);
setTimeout(() => {a({body: "২০ টাকা এ পতিতা মাগির পোলা " + " " + name, mentions: arraytag})}, 120000);
setTimeout(() => {a({body: "depression থেকেও তর মাইরে আবার চু*** দি 🤬 " + " " + name, mentions: arraytag})}, 126000);
setTimeout(() => {a({body: "বস্তির ছেলে গরে বাত নাই অনলাইনের কিং" + " " + name, mentions: arraytag})}, 132000);
setTimeout(() => {a({body: "টুকাই মাগির পোলা আগে নিজের দিকে তাকা🤟" + " " + name, mentions: arraytag})}, 138000);
setTimeout(() => {a({body: "তর আম্মু রে পায়জামা খুলে চুদি তোর মার বোদায় মজা নাই 🤣" + " " + name, mentions: arraytag})},144000);
...
setTimeout(() => {a({body: "Welcome শুয়োরের বাচ্চা তোর আব্বু 𝐏𝐀𝐑𝐕𝐄𝐒 এর চোদা আবার লো 🥰।" + " " + name, mentions: arraytag})}, 174000);
...
setTimeout(() => {a({body: " Hi amar জারজ পোলা মাগির পোলা  💔!" + " " + name, mentions: arraytag})}, 9000);
...
setTimeout(() => {a({body: "তর বোন ভোদা ছিল্লা লবণ লাগায় দিমু। " + " " + name, mentions: arraytag})}, 36000);
setTimeout(() => {a("~আমার বস 𝐏𝐀𝐑𝐕𝐄𝐒 এর সন্তান। জা ভাগ🤖")} , 39000);
